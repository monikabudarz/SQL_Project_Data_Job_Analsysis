...
Question: WHat skills are required for the top_paying data analyst jobs?
    - Use teh top 10 highest_paying Data Analyst jobs from first query
...
SELECT 
    ...
    tpj.salary_year_avg,
    tpj.company_name,
    STRING_AGG(sd.skills, ', ') AS all_skills -- Concatenate skills into one column
...
Python follows closely woth a bold cound of 7. 
